...
//		String [][]matrizString = Array.crearMatrizString(9, 5);
//		Array.mostrarMatrizString(matrizString);
...
//		Array.mostrarMatrizInt(matrizInt);
		
		System.out.println(Frecursivas.fibonacci(6));
